...
export function canDraftField(field) {
  ...
  if (needsPersonalInput(field) || THIRD_PARTY_PATTERN.test(value) || UNSAFE_FIELD_PATTERN.test(value) || DIRECT_IDENTITY_PATTERN.test(value) || LEGAL_OR_DEMOGRAPHIC_PATTERN.test(value)) return false;
